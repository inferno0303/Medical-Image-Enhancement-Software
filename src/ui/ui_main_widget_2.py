...
class Ui_MyMainWidget(object):
    def setupUi(self, MyMainWidget):
        ...
        self.gridLayout.addWidget(self.evalueate_module_btn, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.enhance_module_btn, 2, 0, 1, 2)
    ...
    def retranslateUi(self, MyMainWidget):
        ...
        self.enhance_module_btn.setText(_translate("MyMainWidget", "一键自适应增强"))
