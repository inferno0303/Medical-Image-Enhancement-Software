...
class Ui_ui_subwidget_histogram(object):
    ...
    def retranslateUi(self, ui_subwidget_histogram):
        ...
        self.groupBox_3.setTitle(_translate("ui_subwidget_histogram", "参数调整"))
        self.pushButton.setText(_translate("ui_subwidget_histogram", "PushButton"))
        self.pushButton_2.setText(_translate("ui_subwidget_histogram", "PushButton"))
        self.pushButton_3.setText(_translate("ui_subwidget_histogram", "确定"))
        self.pushButton_4.setText(_translate("ui_subwidget_histogram", "取消"))
